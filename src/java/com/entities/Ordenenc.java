...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "Ordenenc.findAll", query = "SELECT o FROM Ordenenc o WHERE o.ordenencPK.codCia = :codCia and o.tipoOrden = :tipoOrden and o.coddeptoSol = :coddeptoSol order by o.ordenencPK.numOrden desc"),
    ...
    @NamedQuery(name = "Ordenenc.findDocAutorizados", query = "SELECT o FROM Ordenenc o WHERE o.ordenencPK.codCia = :codCia and o.tipoOrden = :tipoOrden and o.autorizado is not null and o.fechautorizado is not null and o.anulado is null and o.fechaanulado is null and o.status not in(:status, :xstatus) order by o.ordenencPK.numOrden desc"),
